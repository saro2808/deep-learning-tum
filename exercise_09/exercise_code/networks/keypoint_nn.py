...
class KeypointModel(nn.Module):
    ...
    def __init__(self, hparams):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(1, 8, 3),   # (N, 8, 94, 94)
            nn.ReLU(),
            nn.MaxPool2d(2),      # (N, 8, 47, 47)
            nn.Conv2d(8, 16, 3),  # (N, 16, 45, 45)
            nn.ReLU(),
            nn.MaxPool2d(3),      # (N, 16, 15, 15)
            nn.Conv2d(16, 32, 3), # (N, 32, 13, 13)
            nn.ReLU(),
            nn.MaxPool2d(3, padding=1)      # (N, 32, 5, 5)
        )
